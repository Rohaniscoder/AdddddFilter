...
auth_channel = environ.get('AUTH_CHANNEL', '-1001713881073')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '')
reqst_channel = environ.get('REQST_CHANNEL', '-1001926797180')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/FILMYKHOJOFFICIAL')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/FILMYKHOJ')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/FILMYKHOJOFFICIAL')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Share And Support ✌')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'FILMYKHOJOFFICIAL')
...
URL = "https://loyalprofessorrobot-prashantbaba000.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://loyalprofessorrobot-prashantbaba000.koyeb.app/".format(FQDN, PORT)
